I'const { getConfig } = require("./lib/configdb");
const fs = require('fs');
...
module.exports = {
    ...
    SESSION_ID: process.env.SESSION_ID || "MEGALODON~MD~hNJWWA7b#blNy8GBBjG8gEiBevkzNlNHACrVJzl00fCFtGKppj9U",  // Your bot's session ID (keep it secure)
    ...
    OWNER_NUMBER: process.env.OWNER_NUMBER || "50943002674",  // Owner's WhatsApp number
    
    OWNER_NAME: process.env.OWNER_NAME || getConfig("OWNER_NAME") || "ᴊᴏᴊᴏ ᴜᴘ",           // Owner's name
    
    DEV: process.env.DEV || "50943002674",                     // Developer's contact number
